    ...
    <div className="citiesDetail">
     ...
     <CitiesButton/>
      ...
      <div className="category">
        <Button onClick={() => handleFilterConcert(name)}>
          <img src={konserIcon} />
          KONSER
        </Button>
        <Button onClick={() => handleFilterTheater(name)}>
          <img src={tiyatroIcon} />
          TİYATRO
        </Button>
        <Button onClick={() => handleFilterFestival(name)}>
          <img src={festivalIcon} />
          FESTİVAL
        </Button>
        <Button onClick={() => handleFilterStandUp(name)}>
          <img src={standupIcon} />
          <p>STAND UP</p>
        </Button>
        <Button onClick={() => handleFilterKidsActivities(name)}>
          <img src={cocukaktviteleriIcon} />
          ÇOCUK <br /> AKTİVİTELERİ
        </Button>
        <Button onClick={() => handleFilterBlog(name)}>
          <img src={blogIcon} />
          BLOG
        </Button>
      </div>
