...
const Header = () => {
  ...
  return (
    ...
    <Radio.Group value={size} onChange={(e) => setSize(e.target.value)}>
      <Radio.Button onClick={handleClick} value="large"><svg width="100%" height="100%" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
      ...
      <Radio.Button value="small" onClick={handleClickTwo}>→| Üye Girişi</Radio.Button>
    </Radio.Group>
    </div>
  </div>
  )
